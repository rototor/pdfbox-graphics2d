...
public class InvalidPDFTest
{
    ...
    public void testInvalidPDF() throws Exception {
        double scale = 0.41688379364252215;
        ...
        g.setStroke(new BasicStroke(0.25f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 0.25f, null, 0.0f));
        ...
        AttributedString as = new AttributedString("OpenText Confidential. ©2019 All Rights ");
        ...
        g.setTransform(new AffineTransform(0.41688379364252215f,0.0f,0.0f,0.41688379364252215f,0.0f,0.0f));
        g.setPaint(new Color(0x00FFFFFF));
        g.setStroke(new BasicStroke(0.25f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 0.25f, null, 0.0f));
        ...
        g.setStroke(new BasicStroke(0.992126f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 0.992126f, null, 0.0f));
